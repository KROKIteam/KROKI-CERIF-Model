...
@Entity
@Table(name = "C1_DUBLIN_CORE_RESOURCE_IDENTIFIER")
public class CfDCResourceIdentifier implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdcresourceidentifier_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdcresourceidentifier_dublinCore;
	
	public CfDCResourceIdentifier(){
	}
	...
	public CfDC getCfdcresourceidentifier_dublinCore() {
		return this.cfdcresourceidentifier_dublinCore;
	}
	
	public void setCfdcresourceidentifier_dublinCore(CfDC cfdcresourceidentifier_dublinCore) {
		this.cfdcresourceidentifier_dublinCore = cfdcresourceidentifier_dublinCore;
	}
