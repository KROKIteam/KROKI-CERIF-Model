...
@Entity
@Table(name = "C1_GEOGRAPHIC_BOUNDING_BOX_CLASSIFICATION")
public class CfGeoBBox_Class implements java.io.Serializable {
	...
	protected CfClass cfgeobbox_class_classification;
	@ManyToOne
	@JoinColumn(name="cfgeobbox_class_geographicBoundingBox", referencedColumnName="ID",  nullable = true)
	protected CfGeoBBox cfgeobbox_class_geographicBoundingBox;
