...
@Entity
@Table(name = "C1_DUBLIN_CORE_PROVENANCE")
public class CfDCProvenance implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdcprovenance_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdcprovenance_dublinCore;
	
	public CfDCProvenance(){
	}
	...
	public CfDC getCfdcprovenance_dublinCore() {
		return this.cfdcprovenance_dublinCore;
	}
	
	public void setCfdcprovenance_dublinCore(CfDC cfdcprovenance_dublinCore) {
		this.cfdcprovenance_dublinCore = cfdcprovenance_dublinCore;
	}
