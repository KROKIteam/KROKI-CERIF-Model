...
@Entity
@Table(name = "C1_DUBLIN_CORE_RIGHTS_MANAGEMENT_ACCESS_RIGHTS")
public class CfDCRightsMMAccessRights implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdcrightsmmaccessrights_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdcrightsmmaccessrights_dublinCore;
	
	public CfDCRightsMMAccessRights(){
	}
	...
	public CfDC getCfdcrightsmmaccessrights_dublinCore() {
		return this.cfdcrightsmmaccessrights_dublinCore;
	}
	
	public void setCfdcrightsmmaccessrights_dublinCore(CfDC cfdcrightsmmaccessrights_dublinCore) {
		this.cfdcrightsmmaccessrights_dublinCore = cfdcrightsmmaccessrights_dublinCore;
	}
