...
@Entity
@Table(name = "C1_DUBLIN_CORE_AUDIENCE")
public class CfDCAudience implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdcaudience_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdcaudience_dublinCore;
	...
	public CfDC getCfdcaudience_dublinCore() {
		return this.cfdcaudience_dublinCore;
	}
	
	public void setCfdcaudience_dublinCore(CfDC cfdcaudience_dublinCore) {
		this.cfdcaudience_dublinCore = cfdcaudience_dublinCore;
	}
