...
@Entity
@Table(name = "C1_DUBLIN_CORE_LANGUAGE")
public class CfDCLanguage implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdclanguage_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdclanguage_dublinCore;
	...
	public CfDC getCfdclanguage_dublinCore() {
		return this.cfdclanguage_dublinCore;
	}
	
	public void setCfdclanguage_dublinCore(CfDC cfdclanguage_dublinCore) {
		this.cfdclanguage_dublinCore = cfdclanguage_dublinCore;
	}
