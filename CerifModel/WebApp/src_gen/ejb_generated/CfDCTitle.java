...
@Entity
@Table(name = "C1_DUBLIN_CORE_TITLE")
public class CfDCTitle implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdctitle_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdctitle_dublinCore;
	...
	public CfDC getCfdctitle_dublinCore() {
		return this.cfdctitle_dublinCore;
	}
	
	public void setCfdctitle_dublinCore(CfDC cfdctitle_dublinCore) {
		this.cfdctitle_dublinCore = cfdctitle_dublinCore;
	}
