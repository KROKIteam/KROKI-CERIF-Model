...
@Entity
@Table(name = "C1_DUBLIN_CORE_CREATOR")
public class CfDCCreator implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdccreator_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdccreator_dublinCore;
	...
	public CfDC getCfdccreator_dublinCore() {
		return this.cfdccreator_dublinCore;
	}
	
	public void setCfdccreator_dublinCore(CfDC cfdccreator_dublinCore) {
		this.cfdccreator_dublinCore = cfdccreator_dublinCore;
	}
