...
@Entity
@Table(name = "C1_EXPERTISE_AND_SKILLS_KEYWORDS")
public class CfExpSkillsKeyw implements java.io.Serializable {
	...
	protected CfLang cfexpskillskeyw_language;
	@ManyToOne
	@JoinColumn(name="cfexpskillskeyw_expertiseAndSkills", referencedColumnName="ID",  nullable = true)
	protected CfExpSkills cfexpskillskeyw_expertiseAndSkills;
	@Column(name = "cfTrans", unique = false, nullable = false , length = 1, precision = 0,columnDefinition = "CHAR")
	protected java.lang.String ka_translation_kind;
	@ManyToOne
	@JoinColumn(name="cfexpskillskeyw_expertiseAndSkillsIntegrated", referencedColumnName="ID",  nullable = true)
	protected Expertiseandskillsintegrated cfexpskillskeyw_expertiseAndSkillsIntegrated;
	...
	public Expertiseandskillsintegrated getCfexpskillskeyw_expertiseAndSkillsIntegrated() {
		return this.cfexpskillskeyw_expertiseAndSkillsIntegrated;
	}
	
	public void setCfexpskillskeyw_expertiseAndSkillsIntegrated(Expertiseandskillsintegrated cfexpskillskeyw_expertiseAndSkillsIntegrated) {
		this.cfexpskillskeyw_expertiseAndSkillsIntegrated = cfexpskillskeyw_expertiseAndSkillsIntegrated;
	}
