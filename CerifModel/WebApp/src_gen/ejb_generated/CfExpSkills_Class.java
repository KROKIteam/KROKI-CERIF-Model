...
@Entity
@Table(name = "CM_EXPERTISE_AND_SKILLS_CLASSIFICATION")
public class CfExpSkills_Class implements java.io.Serializable {
	...
	private CfClass cfexpskills_class_classification;
	@ManyToOne
	@JoinColumn(name="cfexpskills_class_expertiseAndSkills", referencedColumnName="ID",  nullable = true)
	private CfExpSkills cfexpskills_class_expertiseAndSkills;
