...
@Entity
@Table(name = "C1_DUBLIN_CORE_SUBJECT")
public class CfDCSubject implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdcsubject_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdcsubject_dublinCore;
	...
	public CfDC getCfdcsubject_dublinCore() {
		return this.cfdcsubject_dublinCore;
	}
	
	public void setCfdcsubject_dublinCore(CfDC cfdcsubject_dublinCore) {
		this.cfdcsubject_dublinCore = cfdcsubject_dublinCore;
	}
