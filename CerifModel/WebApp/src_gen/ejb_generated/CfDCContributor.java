...
@Entity
@Table(name = "C1_DUBLIN_CORE_CONTRIBUTOR")
public class CfDCContributor implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdccontributor_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdccontributor_dublinCore;
	
	public CfDCContributor(){
	}
	...
	public CfDC getCfdccontributor_dublinCore() {
		return this.cfdccontributor_dublinCore;
	}
	
	public void setCfdccontributor_dublinCore(CfDC cfdccontributor_dublinCore) {
		this.cfdccontributor_dublinCore = cfdccontributor_dublinCore;
	}
