...
@Entity
@Table(name = "C1_DUBLIN_CORE_SOURCE")
public class CfDCSource implements java.io.Serializable {
	...
	@ManyToOne
	@JoinColumn(name="cfdcsource_dublinCore", referencedColumnName="ID",  nullable = true)
	protected CfDC cfdcsource_dublinCore;
	...
	public CfDC getCfdcsource_dublinCore() {
		return this.cfdcsource_dublinCore;
	}
	
	public void setCfdcsource_dublinCore(CfDC cfdcsource_dublinCore) {
		this.cfdcsource_dublinCore = cfdcsource_dublinCore;
	}
